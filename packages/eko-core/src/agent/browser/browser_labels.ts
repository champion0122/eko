  ...
  private ext_tools: Tool[] = [
    {
      ...
      planDescription: `Book a meeting room on https://crm.finereporthelp.com/WebReport/decision?type=logout#directory?activeTab=0d559c9d-cf25-4b22-87d0-b530948b1b5b The process includes the following steps:
